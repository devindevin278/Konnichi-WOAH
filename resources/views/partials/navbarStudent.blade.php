...
<header id="header" class="justify-content-center align-items-center">
    <nav id="navbar" class="navbar" >
            ...
            <ul>
                ...
                <li> <a class="nav-link {{ (Request::is('learnStudent/*') || Request::is('notebook/*'))? 'active' : '' }}" href="/learnStudent/games">Learn</a> </li>
                <li> <a class="nav-link {{ Request::is('articleStudent')? 'active' : '' }}" href="/articleStudent">Article</a> </li>
                <li> <a class="nav-link {{ (Request::is('teacher') || Request::is('viewTeacher/*'))? 'active' : '' }}" href="/teacher">Teacher</a></li>
            </ul>

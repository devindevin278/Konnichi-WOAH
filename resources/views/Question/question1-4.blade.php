...
<body>
    ...
    <div class="upper">
        ...
        <div class="progress" id="process-bar">
            <div class="progress-bar" id="processing" role="progressbar" style="width: 40%;" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
                <div id="process2"></div>
            </div>
        </div>
    </div>
    ...
    <div class="wrronk" id="2" style="display: none">
        ...
        <div class="ann">
            ...
            <h3 style="color: #EE282D; font-size: 1.5vw;">Nice to meet you</h3>
        </div>

...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('congrats.css') }}">
    ...
    <div>
        <div class="congrats-container">
            ...
            <div class="congrats-result">
                <div class="congrats-streak">
                    <h3 class="congrats-result-title">BIGGEST STREAK</h3>

                    <div class="congrats-grat">
                        <svg class="icon_streak" viewBox="-33 0 255 255" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                            <defs>
                              <style>
        ...
        <div class="congrats-footer">
            <form action="/XPscore" method="post">
                ...
                <button type="submit" class="congrats-button continue">Continue</button>
            </form>
        </div>
    </div>
</body>

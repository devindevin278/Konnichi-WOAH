...
<section class="showArticle pt-4 row d-flex">
    ...
    <div class="col-md-11 mx-auto d-flex justify-content-between p-0 m-0">
            ...
            <div class="linking m-0" style="align-items: center">
                <a class="m-0" href="/student/{{ $article->slug }}" style="color:black;">English</a>
                <a class="m-0" style="color:black;">|</a>
                <a class="m-0" href="/jpnstudent/{{ $article->id }}" style="color:black;"><u>Japanese</u></a>
            </div>
        {{-- </div> --}}
    </div>
    ...
    {{-- <div class="row col-md-11 mx-auto p-0"> --}}
        <div class="col-md-8 m-0 p-0 mx-auto">
            ...
            <div class=" mt-3 d-flex jusify-content-around align-items-center">
                <div class=" titlearticle p-0">{{ $article->jpntitle }}</div>
        ...
        <div class="col-md-4">
            <div class="card d-flex p-0 justify-content-around"
                ...
                <div class="card-body rounded-bottom border-0"
                    style="background-color: #ffffff;">
                    <h5 class="card-title " style="height: 5vw">
                        <a href="/jpnstudent/{{ $articl->id }}"
                            style="color: black;">{{ $articl->jpntitle }}</a>
                    </h5>
                    {{-- <a class="card-title text-decoration-none"
                        href="/author/{{ $articl->author->name }}"
                        style="color: black;">{{ $articl->author->name }}</a> --}}

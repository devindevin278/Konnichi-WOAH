...
<body style="background: #faeee7;font-family: Poppins, sans-serif;">
                ...
                <div class="carousel-item active">
                    <div class="container d-xl-flex justify-content-xl-center align-items-xl-center">
                        <div class="row d-xl-flex justify-content-xl-center align-items-xl-center" style="padding-top: 0;margin-top: 1px;margin-right: 14px;margin-left: 61px;">
                            ...
                            <div class="col-md-6 d-xl-flex justify-content-center justify-content-xl-center align-items-xl-center"><img class="d-xl-flex align-items-center align-items-xl-center" src=""></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container py-4 py-xl-5" style="color: rgb(255,255,255);margin-top: -85px;">
    ...
    <section>
        <div class="d-xl-flex" style="background: #594a4e;">
            <div class="container">
                <div class="row">
                    <div class="col">

                ...
                <div class="col d-flex mt-3 ">
                    <div class="row d-flex align-items-start me-5" style="width:65%;">
                        <div class="row d-flex align-items-start " style="font-weight: 600; font-size: 25px;">
                            Private Japanesse classes for students and adults, with learning materials tailored to your
                            specific needs. Because practice makes perfect, let me assist you in learning.
                        </div>
                        ...
                        <div class="d-flex row gap-5 mt-3" style="font-weight: 400;">
                            <div
                                class="mt-3 col d-flex align-items-center justify-content-center rounded-5"style="border: solid black; width:fit;">
                                ...
                                <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#000000"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M12 2C7.58172 2 4 5.58172 4 10C4 14.4183 7.58172 18 12 18C16.4183 18 20 14.4183 20 10C20 5.58172 16.4183 2 12 2ZM12 6C9.79086 6 8 7.79086 8 10C8 12.2091 9.79086 14 12 14C14.2091 14 16 12.2091 16 10C16 7.79086 14.2091 6 12 6Z"
                                            fill="#000000"></path>
                                        <path
                                            d="M7.26067 17.6525L6.70006 18.4C5.5876 19.8833 6.64595 22 8.50006 22H15.5001C17.3542 22 18.4125 19.8833 17.3001 18.4L16.7394 17.6525C15.363 18.5067 13.7391 19 12 19C10.2609 19 8.63706 18.5067 7.26067 17.6525Z"
                                            fill="#000000"></path>
                                    </g>
                                </svg>
                                {{-- </div> --}}
                            ...
                            <div
                                class="col mt-3 d-flex align-items-center justify-content-center rounded-5"style="border: solid black; ">
                                <div class="p-1">
                                    <svg width="30px" height="30px" version="1.0" id="Layer_1"
                    ...
                    <div class="row d-flex align-items-start justify-content-around" style="width:30%; height: 480px;">
                        <div class="row d-flex justify-content-center bg-white p-3 shadow"
                            ...
                            <div class="d-flex justify-content-center text-center align-items-center p-0"
                                style="width:60%;">
                                <h4>
                                    {{ $user->name }}
                                </h4>
                            </div>
                            <div class="row d-flex justify-content-center text-center align-items-center p-0"
                                style="width:60%;">
                                Tuition fee:
                            ...
                            <form class="d-flex justify-content-center align-items-center" id="submitrequest"
                                action="/requestTeacher" method="post">
                                @csrf
                                <input type="hidden" name="name" value="{{ auth()->user()->name }}">
                                <input type="hidden" name="email" value="{{ auth()->user()->email }}">
                                <input type="hidden" name="phone" value="{{ auth()->user()->phoneNumber }}">
                                ...
                                <div class="mt-2 col d-flex reqteacher justify-content-center">
                                    @if (in_array($user->id, $pendingTeacherId))
                                    <div class="submitbtn d-flex align-items-center justify-content-center" id=""
                                    style="">Requested</div>
                                    @else
                                    <div class="d-flex justify-content-center align-items-center">
                                        ...
                                        <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                <path d="M7 16H4V4H20V6M7 18.5V21L12 16H20V10" stroke="#000000"
                                                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                                </path>
                                            </g>
                                        </svg>
                                    </div>
                                    <button class="submitbtn" type="submit" id="requestTeacherButton"
                                        style="">Request Teacher</button>
                                    @endif
                                </div>
                            </form>
                    ...
                    <div id="popup_confirmrequest" class="popup_confirmrequest">
                        @if (!auth()->user()->address)
                            <div class="popup_confirmrequest-content d-flex flex-column">
                                ...
                                <a class="btn btn-back ms-auto rounded-5"
                                    style="background-color:#FFC6C7; width: fit-content" href="/profileStudent">Go to
                                    profile</a>
                            </div>
                        @else
                            <div class="popup_confirmrequest-content d-flex flex-column">
                                ...
                                <div class="button ms-auto">
                                    <a class="btn btn-back ms-auto rounded-5"
                                        style="border: 2px solid #FFC6C7; width: fit-content" href="/profileStudent">Edit
                                        profile</a>
                                    <button class="btn btn-back ms-auto rounded-5" onclick="return form_submit.submit()"
                                        style="background-color:#FFC6C7; width: fit-content">Send request</button>
                                </div>
                            </div>
                        @endif
                    </div>

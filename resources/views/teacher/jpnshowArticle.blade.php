...
<section class="showArticle pt-4 p-0 row m-0 d-flex">
    ...
    <div class="col-md-11 mx-auto d-flex justify-content-between p-0 m-0">
            ...
            <a class="btn btn-back" style="background-color:#FFC6C7;" href="/articleTeacher">Back</a>

            <div class="linking m-0" style="align-items: center">
                <a class="m-0" href="/teacher/{{ $article->slug }}" style="color:black;">English</a>
                <a class="m-0" style="color:black;">|</a>
                <a class="m-0" href="#" style="color:black;"><u>Japanese</u></a>
            </div>
        {{-- </div> --}}
    </div>

        ...
        <form method="post" action="/admin/{{ $articles->slug }}" enctype="multipart/form-data">
            ...
            <div class="container row mt-5 d-flex m-auto justify-content-center" style="width: fit">
                ...
                <input class="form-control d-flex justify-content-center"
                    style="max-height: 30vh; top: 186px;
                    background: #FFC6C7;" type="file"
            ...
            <div class="container mt-3 d-flex jusify-content-around">
                <div class="input-group date" style="width:17vw;">
                    <input type="date" class="form-control" id="date" name="articlepublish"
                        style="background: #FFC6C7;" value="{{ old('date', $articles->articlepublish) }}">
                </div>
            </div>
            ...
            <div class="container mt-3 d-flex align-items-center">
                ...
                @enderror"
                        id="title" name="title" placeholder="Add title" value="{{ old('title', $articles->title) }}"
            ...
            <div class="container mt-3 d-flex align-items-center">
                ...
                @enderror"
                        id="jpntitle" name="jpntitle" placeholder="Add jpntitle"
                        value="{{ old('jpntitle', $articles->jpntitle) }}" style="background: #FFC6C7;width:35vw;">
                    @error('jpntitle')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="container mt-3 d-flex align-items-center">
                <div style="width: fit;">
                    <select class="form-select" name="author_id" value="Choose author name" value="{{ old('author') }}"
                        style="background: #FFC6C7;">
            ...
            <div class="container mt-3 d-flex align-items-center">
                <div style="width: fit;">
                 ...
                 @enderror"
                        id="slug" name="slug" placeholder="Slug Auto generated"
                        value="{{ old('slug', $articles->slug) }}" style="background: #FFC6C7;width:35vw;">

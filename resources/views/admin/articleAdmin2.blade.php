            ...
            <div class="container  align-items-center mt-5">
                <div class="d-flex align-items-center justify-content-between">
                    {{-- <div class="m-0 p-0"> --}}
                        ...
                        <h2 class="w-50" style="font-weight:600;">Want to know more about Japan?</h2>
                        {{-- </div> --}}
                    {{-- </div> --}}
                    <a href="/addArticle" class="p-0"><img class="justify-content-end align-items-right mx-0 addarticle" src="{{ asset('img/addarticle.png') }}" alt=""></a>
                </div>

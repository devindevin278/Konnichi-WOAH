                  ...
                  <tr class="" >
                    ...
                    <tbody class="table_border">
                        ...
                        <tr style="@if($loop->odd)
                          ...
                          <td class="text-start col-md-3">{{ $payment['name'] }}</td>
                          <td class="text-start col-md-3">{{ $payment['email'] }}</td>
                          <td>{{ $payment['paymentStatus'] }}</td>
                          <td><a type="button" class="payment_detail text-black" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-name="{{ $payment['name'] }} " data-bs-email="{{ $payment['email'] }}">Detail</a></td>
                        </tr>
                        @endforeach
                    </tbody>
              </table>
...
<script src="{{ asset('js/verifyPayment.js') }}"></script>
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="mt-1 d-flex">
                ...
                <img src="img/verifyPayment/buktitransfer.png" alt="">
            </div>
          </form>
        </div>

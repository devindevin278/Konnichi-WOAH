                ...
                <div class="col border-right ms-5 me-5">
                    ...
                    <div class="d-flex col justify-content-center">
                        <div class="d-flex justify-content-around mt-3" >
                            ...
                            <form action="/profileAdmin/{{ $user->id }}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
            ...
            <div class="row">
                <div class="col">
                    <div class="p-3 py-5">
                        ...
                        <div class="d-flex justify-content-around  mb-5 text-center"><a href="/profileAdmin/{{ $user->id }}/edit"  class="btnsave no-decoration-text logoutedit" style="color: #33272A;">Edit</a></div>

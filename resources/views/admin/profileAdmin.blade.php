            ...
            <div class="row">
                <div class="col">
                    <div class="p-3 py-5">
                        ...
                        <div class="d-flex justify-content-around  mb-5 text-center"><a href="/profileAdmin/{{ $user->id }}/edit"  class="btnsave no-decoration-text" style="color: #33272A;">Edit</a></div>
